...
-- create view ltb_avh_occurrence_core_view as
select 
  ...
  */
  ...
  -- rightsHolder
  'La Trobe University' AS rightsHolder,

  -- institutionCode
  'LTB' as institutionCode,

  -- collectionCode
  'LTB' as collectionCode,
  ...
  */
  ...
  -- catalogNumber
  concat('LTB ', co.CatalogNumber) as catalogNumber,

  -- occurrenceRemarks
  co.Remarks as occurrenceRemarks,
...
where co.CollectionID=4 and co.CatalogNumber is not null and co.GUID is not null
